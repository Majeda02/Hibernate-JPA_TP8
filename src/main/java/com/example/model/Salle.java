...
public class Salle {
    ...
    public Salle(Long id, Long version, Set<Equipement> equipements, List<Reservation> reservations, String numero, Integer etage, String batiment, String description, Integer capacite, String nom) {
        this.id = id;
